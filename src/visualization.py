...
class ResultVisualizer:
    ...
    def create_comparison_figure(self,
        ...
        """Создание комплексной фигуры с результатами"""
        if diff_map is None:
        ...
        # 1. Исходные изображения и разность
        ...
        # 3. Ground truth и оценка (если есть)
    ...
    def create_comparison_plot(results_df: pd.DataFrame, output_path: str):
        ...
        # Тепловая карта (только если есть данные и методы)
